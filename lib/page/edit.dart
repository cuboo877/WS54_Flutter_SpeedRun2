...
class _EditPageState extends State<EditPage> {
  ...
  Widget submitPasswordButton(BuildContext context) {
    return TextButton(
      style: TextButton.styleFrom(
        ...
        if (isEdited) {
          if (isLoginValid && isPasswordValid && istUrlValid && istagValid) {
            ...
            if (mounted) {
              ...
              Utilities.showNormalSnackBar(context, "已更改密碼資料", 2);
            }
          } else {
                        ...
                        TextButton(
                          ...
                          onPressed: () async {
                            Navigator.of(context).pushReplacement(
                                MaterialPageRoute(
                                    builder: (context) =>
                                        HomePage(userID: widget.data.userID)));
                          },
                        )
                      ],
                    );
